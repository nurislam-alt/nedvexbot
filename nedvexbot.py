...
def AtriumAvenuePresentation(client,cb_qry:CallbackQuery):
	app.send_document(cb_qry.message.chat.id, document = r"C:\Users\Нурислам\Desktop\my programs and sites\фриланс коды\бот для nedvex\Атриум Авеню_мобильная.pdf")
	cb_qry.answer()
...
def ВолнаPresentation(client,cb_qry:CallbackQuery):
	app.send_document(cb_qry.message.chat.id, document = r"C:\Users\Нурислам\Desktop\my programs and sites\фриланс коды\бот для nedvex\Volna Resort.pdf")
	cb_qry.answer()
...
def VolnaRezidnesPresentation(client,cb_qry:CallbackQuery):
	app.send_document(cb_qry.message.chat.id, r"C:\Users\Нурислам\Desktop\my programs and sites\фриланс коды\бот для nedvex\Микропрезентация Volna Residence.pdf")
...
def AtlasPresentation(client,cb_qry:CallbackQuery):
	app.send_document(cb_qry.message.chat.id, r"C:\Users\Нурислам\Desktop\my programs and sites\фриланс коды\бот для nedvex\Презентация Атлас.pdf")
	cb_qry.answer()
...
def LuchezarniyPresentation(client,cb_qry:CallbackQuery):
	app.send_document(cb_qry.message.chat.id, r"C:\Users\Нурислам\Desktop\my programs and sites\фриланс коды\бот для nedvex\Буклет Лучезарный.pdf")
	cb_qry.answer()
...
def WoodlandPresentation(client,cb_qry:CallbackQuery):
	app.send_document(cb_qry.message.chat.id, r"C:\Users\Нурислам\Desktop\my programs and sites\фриланс коды\бот для nedvex\Презентация Woodland.pdf")
	cb_qry.answer()
...
def oplympicPresentation(client,cb_qry:CallbackQuery):
	app.send_document(cb_qry.message.chat.id, r"C:\Users\Нурислам\Desktop\my programs and sites\фриланс коды\бот для nedvex\Презентация Олимпик 2.pdf")
	cb_qry.answer()
...
def sydneyPresentation(client,cb_qry:CallbackQuery):
	app.send_document(cb_qry.message.chat.id, r"C:\Users\Нурислам\Desktop\my programs and sites\фриланс коды\бот для nedvex\Презентация Sydney.pdf")
	cb_qry.answer()
...
def simphonyPresentation(client,cb_qry:CallbackQuery):
	app.send_document(cb_qry.message.chat.id, r"C:\Users\Нурислам\Desktop\my programs and sites\фриланс коды\бот для nedvex\Презентация Морская симфония 2 - Пентхаусы.pdf")
	cb_qry.answer()
...
def kvartalPresentation(client,cb_qry:CallbackQuery):
	app.send_document(cb_qry.message.chat.id, r"C:\Users\Нурислам\Desktop\my programs and sites\фриланс коды\бот для nedvex\Морской Квартал моб презентация.pdf")
	cb_qry.answer()
...
def royalPresentation(client,cb_qry:CallbackQuery):
	app.send_document(cb_qry.message.chat.id, r"C:\Users\Нурислам\Desktop\my programs and sites\фриланс коды\бот для nedvex\Книга -презентация Гранд Роял.pdf")
	cb_qry.answer()
...
def loyal_program(client,message):
	app.send_document(message.chat.id, r"C:\Users\Нурислам\Desktop\my programs and sites\фриланс коды\бот для nedvex\Программа лояльности (Mobile).pdf")

@app.on_message(filters.regex("Партнерская программа"))
def partner_program(client,message):
	app.send_document(message.chat.id, r"C:\Users\Нурислам\Desktop\my programs and sites\фриланс коды\бот для nedvex\Партнерская программа (Mobile).pdf")
